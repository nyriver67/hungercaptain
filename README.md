...
Check out [FRONTEND LIVE DEMO](https://hungercaptain-frontend.aniyarivera.repl.co/) here!!

Check out [API LIVE DEMO](https://hungercaptain-backend.aniyarivera.repl.co) here!!
...
1. Git Clone https://github.com/nyriver67/hungercaptain.git
